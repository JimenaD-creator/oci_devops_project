...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password.length < 6)  { setErrorMsg('Minimum 6 characters.');   return; }
      ...
      <div className="login-card">
        ...
        <form className="login-form" onSubmit={handleSubmit} noValidate>
          <div className="login-field-group">
            ...
            <div className={focusedField === 'pw' ? 'login-input-wrapper login-input-wrapper--focused' : 'login-input-wrapper'}>
              <input
                id="rp-password"
                type="password"
          ...
          <div className="login-field-group">
            ...
            <div className={focusedField === 'cf' ? 'login-input-wrapper login-input-wrapper--focused' : 'login-input-wrapper'}>
              <input
                id="rp-confirm"
                type="password"
                className="login-input"
