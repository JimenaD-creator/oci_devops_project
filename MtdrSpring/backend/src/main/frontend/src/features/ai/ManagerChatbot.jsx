      ...
      {lines.map((line, i) => {
        ...
        return (
          <Box
            key={i}
            component="span"
            sx={{ display: 'block', pl: isBullet ? 1.5 : 0, position: 'relative' }}
          >
            {isBullet && (
              <Box
                component="span"
            ...
            {rendered}
            {i < lines.length - 1 && !isBullet && line.trim() === '' && (
              <Box component="span" sx={{ display: 'block', height: '0.4em' }} />
            )}
          </Box>
        );
      })}
...
export default function ManagerChatbot({ projectId }) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const reply = data.error ? `⚠️ ${data.reply || getErrorMessage(data.errorCode)}` : data.reply;
            ...
            >
              <Box
                ...
                sx={{
                  ...
                  cursor: 'pointer',
                  boxShadow: isDark
                    ? '0 4px 20px rgba(229,57,53,0.35)'
                    : '0 4px 20px rgba(229,57,53,0.45)',
                  color: '#fff',
                  transition: 'transform 0.2s, box-shadow 0.2s',
                  '&:hover': {
                    transform: 'scale(1.08)',
                    boxShadow: isDark
                      ? '0 6px 28px rgba(229,57,53,0.45)'
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                    ...
                    <Typography
                      sx={{ color: isDark ? '#9A9A9A' : '#888', fontSize: '0.7rem', mt: 0.1 }}
                    >
                    ...
                    <Select
                      ...
                      sx={{
                        ...
                        '& .MuiOutlinedInput-notchedOutline': {
                          borderColor: isDark ? '#2A2C32' : '#E8E8E8',
                        },
                ...
                >
                  ...
                  {messages.length === 0 && (
                    ...
                    >
                      ...
                      <Box
                        sx={{ display: 'flex', flexDirection: 'column', gap: 0.75, width: '100%' }}
                      >
                        {suggestions.map((s, i) => (
                          <Box
                            key={i}
                ...
                >
                  <TextField
                    ...
                    placeholder={aiBlocked ? 'AI chat unavailable' : 'Ask about your project...'}
                    multiline
                    maxRows={3}
                    fullWidth
                    size="small"
                  ...
                  <IconButton
                    ...
                    sx={{
                      ...
                      '&.Mui-disabled': {
                        background: isDark ? '#2A2C32' : '#EEEEEE',
                        color: isDark ? '#5A5A5A' : '#BDBDBD',
                      },
                    }}
                  >
                    {loading ? (
                      <CircularProgress size={16} sx={{ color: isDark ? '#9A9A9A' : '#999' }} />
                    ) : (
                      <SendIcon />
                    )}
                  </IconButton>
