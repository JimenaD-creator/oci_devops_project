    ...
    <>
      <style>
        {`
          ...
          .kpi-title { font-size: 12px; font-weight: 600; color: #6F6F6F; margin-bottom: 12px; line-height: 1.25; }
          .kpi-content-flex { display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 12px; }
          .kpi-label-small { font-size: 11px; color: #6F6F6F; }
          .kpi-value-base { font-size: 14px; font-weight: 600; color: #6F6F6F; }
